...
mixin _$ProfileEntity {
 ...
 String get id; String get name; String? get avatarUrl; String? get coverUrl; String? get jobTitle; String? get company; String? get bio; String? get missionName; String? get groupName; String? get email; String? get phone; String? get cpf; String? get ssn; String? get nationality; String? get zipCode; String? get state; String? get city; String? get street; String? get number; String? get neighborhood; String? get complement; DateTime? get birthDate; String? get country; String? get badgeName; String? get emergencyName; String? get emergencyRelationship; String? get emergencyContact; List<String>? get foodPreferences; List<String>? get medicalRestrictions; int get connectionsCount; int get postsCount; int get missionsCount; ConnectionStatus get connectionStatus;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProfileEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.coverUrl, coverUrl) || other.coverUrl == coverUrl)&&(identical(other.jobTitle, jobTitle) || other.jobTitle == jobTitle)&&(identical(other.company, company) || other.company == company)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.missionName, missionName) || other.missionName == missionName)&&(identical(other.groupName, groupName) || other.groupName == groupName)&&(identical(other.email, email) || other.email == email)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.cpf, cpf) || other.cpf == cpf)&&(identical(other.ssn, ssn) || other.ssn == ssn)&&(identical(other.nationality, nationality) || other.nationality == nationality)&&(identical(other.zipCode, zipCode) || other.zipCode == zipCode)&&(identical(other.state, state) || other.state == state)&&(identical(other.city, city) || other.city == city)&&(identical(other.street, street) || other.street == street)&&(identical(other.number, number) || other.number == number)&&(identical(other.neighborhood, neighborhood) || other.neighborhood == neighborhood)&&(identical(other.complement, complement) || other.complement == complement)&&(identical(other.birthDate, birthDate) || other.birthDate == birthDate)&&(identical(other.country, country) || other.country == country)&&(identical(other.badgeName, badgeName) || other.badgeName == badgeName)&&(identical(other.emergencyName, emergencyName) || other.emergencyName == emergencyName)&&(identical(other.emergencyRelationship, emergencyRelationship) || other.emergencyRelationship == emergencyRelationship)&&(identical(other.emergencyContact, emergencyContact) || other.emergencyContact == emergencyContact)&&const DeepCollectionEquality().equals(other.foodPreferences, foodPreferences)&&const DeepCollectionEquality().equals(other.medicalRestrictions, medicalRestrictions)&&(identical(other.connectionsCount, connectionsCount) || other.connectionsCount == connectionsCount)&&(identical(other.postsCount, postsCount) || other.postsCount == postsCount)&&(identical(other.missionsCount, missionsCount) || other.missionsCount == missionsCount)&&(identical(other.connectionStatus, connectionStatus) || other.connectionStatus == connectionStatus));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,name,avatarUrl,coverUrl,jobTitle,company,bio,missionName,groupName,email,phone,cpf,ssn,nationality,zipCode,state,city,street,number,neighborhood,complement,birthDate,country,badgeName,emergencyName,emergencyRelationship,emergencyContact,const DeepCollectionEquality().hash(foodPreferences),const DeepCollectionEquality().hash(medicalRestrictions),connectionsCount,postsCount,missionsCount,connectionStatus]);

@override
String toString() {
  return 'ProfileEntity(id: $id, name: $name, avatarUrl: $avatarUrl, coverUrl: $coverUrl, jobTitle: $jobTitle, company: $company, bio: $bio, missionName: $missionName, groupName: $groupName, email: $email, phone: $phone, cpf: $cpf, ssn: $ssn, nationality: $nationality, zipCode: $zipCode, state: $state, city: $city, street: $street, number: $number, neighborhood: $neighborhood, complement: $complement, birthDate: $birthDate, country: $country, badgeName: $badgeName, emergencyName: $emergencyName, emergencyRelationship: $emergencyRelationship, emergencyContact: $emergencyContact, foodPreferences: $foodPreferences, medicalRestrictions: $medicalRestrictions, connectionsCount: $connectionsCount, postsCount: $postsCount, missionsCount: $missionsCount, connectionStatus: $connectionStatus)';
}
...
@useResult
$Res call({
 String id, String name, String? avatarUrl, String? coverUrl, String? jobTitle, String? company, String? bio, String? missionName, String? groupName, String? email, String? phone, String? cpf, String? ssn, String? nationality, String? zipCode, String? state, String? city, String? street, String? number, String? neighborhood, String? complement, DateTime? birthDate, String? country, String? badgeName, String? emergencyName, String? emergencyRelationship, String? emergencyContact, List<String>? foodPreferences, List<String>? medicalRestrictions, int connectionsCount, int postsCount, int missionsCount, ConnectionStatus connectionStatus
});
...
/// Create a copy of ProfileEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? avatarUrl = freezed,Object? coverUrl = freezed,Object? jobTitle = freezed,Object? company = freezed,Object? bio = freezed,Object? missionName = freezed,Object? groupName = freezed,Object? email = freezed,Object? phone = freezed,Object? cpf = freezed,Object? ssn = freezed,Object? nationality = freezed,Object? zipCode = freezed,Object? state = freezed,Object? city = freezed,Object? street = freezed,Object? number = freezed,Object? neighborhood = freezed,Object? complement = freezed,Object? birthDate = freezed,Object? country = freezed,Object? badgeName = freezed,Object? emergencyName = freezed,Object? emergencyRelationship = freezed,Object? emergencyContact = freezed,Object? foodPreferences = freezed,Object? medicalRestrictions = freezed,Object? connectionsCount = null,Object? postsCount = null,Object? missionsCount = null,Object? connectionStatus = null,}) {
...
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.id,_that.name,_that.avatarUrl,_that.coverUrl,_that.jobTitle,_that.company,_that.bio,_that.missionName,_that.groupName,_that.email,_that.phone,_that.cpf,_that.ssn,_that.nationality,_that.zipCode,_that.state,_that.city,_that.street,_that.number,_that.neighborhood,_that.complement,_that.birthDate,_that.country,_that.badgeName,_that.emergencyName,_that.emergencyRelationship,_that.emergencyContact,_that.foodPreferences,_that.medicalRestrictions,_that.connectionsCount,_that.postsCount,_that.missionsCount,_that.connectionStatus);case _:
  return orElse();
...
class _ProfileEntity extends ProfileEntity {
  const _ProfileEntity({required this.id, required this.name, required this.avatarUrl, required this.coverUrl, required this.jobTitle, required this.company, required this.bio, required this.missionName, required this.groupName, required this.email, required this.phone, required this.cpf, required this.ssn, required this.nationality, required this.zipCode, required this.state, required this.city, required this.street, required this.number, required this.neighborhood, required this.complement, required this.birthDate, required this.country, required this.badgeName, required this.emergencyName, required this.emergencyRelationship, required this.emergencyContact, required final  List<String>? foodPreferences, required final  List<String>? medicalRestrictions, required this.connectionsCount, required this.postsCount, required this.missionsCount, this.connectionStatus = ConnectionStatus.none}): _foodPreferences = foodPreferences,_medicalRestrictions = medicalRestrictions,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProfileEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.coverUrl, coverUrl) || other.coverUrl == coverUrl)&&(identical(other.jobTitle, jobTitle) || other.jobTitle == jobTitle)&&(identical(other.company, company) || other.company == company)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.missionName, missionName) || other.missionName == missionName)&&(identical(other.groupName, groupName) || other.groupName == groupName)&&(identical(other.email, email) || other.email == email)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.cpf, cpf) || other.cpf == cpf)&&(identical(other.ssn, ssn) || other.ssn == ssn)&&(identical(other.nationality, nationality) || other.nationality == nationality)&&(identical(other.zipCode, zipCode) || other.zipCode == zipCode)&&(identical(other.state, state) || other.state == state)&&(identical(other.city, city) || other.city == city)&&(identical(other.street, street) || other.street == street)&&(identical(other.number, number) || other.number == number)&&(identical(other.neighborhood, neighborhood) || other.neighborhood == neighborhood)&&(identical(other.complement, complement) || other.complement == complement)&&(identical(other.birthDate, birthDate) || other.birthDate == birthDate)&&(identical(other.country, country) || other.country == country)&&(identical(other.badgeName, badgeName) || other.badgeName == badgeName)&&(identical(other.emergencyName, emergencyName) || other.emergencyName == emergencyName)&&(identical(other.emergencyRelationship, emergencyRelationship) || other.emergencyRelationship == emergencyRelationship)&&(identical(other.emergencyContact, emergencyContact) || other.emergencyContact == emergencyContact)&&const DeepCollectionEquality().equals(other._foodPreferences, _foodPreferences)&&const DeepCollectionEquality().equals(other._medicalRestrictions, _medicalRestrictions)&&(identical(other.connectionsCount, connectionsCount) || other.connectionsCount == connectionsCount)&&(identical(other.postsCount, postsCount) || other.postsCount == postsCount)&&(identical(other.missionsCount, missionsCount) || other.missionsCount == missionsCount)&&(identical(other.connectionStatus, connectionStatus) || other.connectionStatus == connectionStatus));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,name,avatarUrl,coverUrl,jobTitle,company,bio,missionName,groupName,email,phone,cpf,ssn,nationality,zipCode,state,city,street,number,neighborhood,complement,birthDate,country,badgeName,emergencyName,emergencyRelationship,emergencyContact,const DeepCollectionEquality().hash(_foodPreferences),const DeepCollectionEquality().hash(_medicalRestrictions),connectionsCount,postsCount,missionsCount,connectionStatus]);
