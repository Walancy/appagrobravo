...
class _ProfileEntity extends ProfileEntity {
  const _ProfileEntity({required this.id, required this.name, required this.avatarUrl, required this.coverUrl, required this.jobTitle, required this.company, required this.bio, required this.missionName, required this.groupName, required this.email, required this.phone, required this.cpf, required this.ssn, required this.zipCode, required this.state, required this.city, required this.street, required this.number, required this.neighborhood, required this.complement, required this.birthDate, required this.country, required this.badgeName, required this.emergencyContact, required final  List<String>? foodPreferences, required final  List<String>? medicalRestrictions, required this.connectionsCount, required this.postsCount, required this.missionsCount, this.connectionStatus = ConnectionStatus.none}): _foodPreferences = foodPreferences,_medicalRestrictions = medicalRestrictions,super._();
