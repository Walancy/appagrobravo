...
@JsonKey(name: 'preco') String? get price;@JsonKey(name: 'site_url') String? get siteUrl;@JsonKey(name: 'status') String? get bookingStatus;// Transfer pickup time (separate from event start)
@JsonKey(name: 'transfer_data') String? get transferDate;@JsonKey(name: 'transfer_hora') String? get transferHora;// Attachments (per-event docs/links)
@JsonKey(name: 'attachments') List<Map<String, dynamic>>? get attachments;// Per-passenger filter
@JsonKey(name: 'passageiros') List<dynamic>? get passageiros;// Google Places ID
@JsonKey(name: 'place_id') String? get placeId;
...
as String?,transferDate: freezed == transferDate ? _self.transferDate : transferDate // ignore: cast_nullable_to_non_nullable
as String?,transferHora: freezed == transferHora ? _self.transferHora : transferHora // ignore: cast_nullable_to_non_nullable
as String?,attachments: freezed == attachments ? _self.attachments : attachments // ignore: cast_nullable_to_non_nullable
as List<Map<String, dynamic>>?,passageiros: freezed == passageiros ? _self.passageiros : passageiros // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,placeId: freezed == placeId ? _self.placeId : placeId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class _ItineraryItemDto extends ItineraryItemDto {
  const _ItineraryItemDto({@JsonKey(name: 'id') required this.id, @JsonKey(name: 'titulo') this.title, @JsonKey(name: 'nome') this.oldName, @JsonKey(name: 'subtitulo') this.subtitle, @JsonKey(name: 'tipo') required this.typeString, @JsonKey(name: 'data') this.dateString, @JsonKey(name: 'hora_inicio') this.timeString, @JsonKey(name: 'hora_fim') this.endTimeString, @JsonKey(name: 'hora_inicio2') this.startDateTimeOld, @JsonKey(name: 'descricao') this.description, @JsonKey(name: 'localizacao') this.location, @JsonKey(name: 'imagem') this.imageUrl, @JsonKey(name: 'codigo_de') this.fromCode, @JsonKey(name: 'codigo_para') this.toCode, @JsonKey(name: 'de') this.fromCity, @JsonKey(name: 'para') this.toCity, @JsonKey(name: 'hora_de') this.fromTime, @JsonKey(name: 'hora_para') this.toTime, @JsonKey(name: 'atrasado') this.isDelayed, @JsonKey(name: 'atraso') this.delay, @JsonKey(name: 'motorista') this.driverName, @JsonKey(name: 'duracao') this.durationString, @JsonKey(name: 'tempo_deslocamento') this.travelTime, @JsonKey(name: 'conexoes') final  List<Map<String, dynamic>>? connections, @JsonKey(name: 'escalas') final  List<Map<String, dynamic>>? escalas, @JsonKey(name: 'endereco') this.address, @JsonKey(name: 'cidade') this.city, @JsonKey(name: 'estado') this.state, @JsonKey(name: 'pais') this.country, @JsonKey(name: 'latitude') this.latitude, @JsonKey(name: 'longitude') this.longitude, @JsonKey(name: 'rating') this.rating, @JsonKey(name: 'estrelas') this.estrelas, @JsonKey(name: 'telefone') this.telefone, @JsonKey(name: 'website') this.website, @JsonKey(name: 'imagens') final  List<String>? images, @JsonKey(name: 'link_maps') this.linkMaps, @JsonKey(name: 'evento_referencia_id') this.eventoReferenciaId, @JsonKey(name: 'is_day_after_transfer') this.isDayAfterTransfer, @JsonKey(name: 'dados') final  Map<String, dynamic>? dados, @JsonKey(name: 'preco') this.price, @JsonKey(name: 'site_url') this.siteUrl, @JsonKey(name: 'status') this.bookingStatus, @JsonKey(name: 'transfer_data') this.transferDate, @JsonKey(name: 'transfer_hora') this.transferHora, @JsonKey(name: 'attachments') final  List<Map<String, dynamic>>? attachments, @JsonKey(name: 'passageiros') final  List<dynamic>? passageiros, @JsonKey(name: 'place_id') this.placeId}): _connections = connections,_escalas = escalas,_images = images,_dados = dados,_attachments = attachments,_passageiros = passageiros,super._();
...
@override@JsonKey(name: 'transfer_data') final  String? transferDate;
@override@JsonKey(name: 'transfer_hora') final  String? transferHora;
...
// Per-passenger filter
 final  List<dynamic>? _passageiros;
// Per-passenger filter
@override@JsonKey(name: 'passageiros') List<dynamic>? get passageiros {
  final value = _passageiros;
  if (value == null) return null;
  if (_passageiros is EqualUnmodifiableListView) return _passageiros;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ItineraryItemDto&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.oldName, oldName) || other.oldName == oldName)&&(identical(other.subtitle, subtitle) || other.subtitle == subtitle)&&(identical(other.typeString, typeString) || other.typeString == typeString)&&(identical(other.dateString, dateString) || other.dateString == dateString)&&(identical(other.timeString, timeString) || other.timeString == timeString)&&(identical(other.endTimeString, endTimeString) || other.endTimeString == endTimeString)&&(identical(other.startDateTimeOld, startDateTimeOld) || other.startDateTimeOld == startDateTimeOld)&&(identical(other.description, description) || other.description == description)&&(identical(other.location, location) || other.location == location)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.fromCode, fromCode) || other.fromCode == fromCode)&&(identical(other.toCode, toCode) || other.toCode == toCode)&&(identical(other.fromCity, fromCity) || other.fromCity == fromCity)&&(identical(other.toCity, toCity) || other.toCity == toCity)&&(identical(other.fromTime, fromTime) || other.fromTime == fromTime)&&(identical(other.toTime, toTime) || other.toTime == toTime)&&(identical(other.isDelayed, isDelayed) || other.isDelayed == isDelayed)&&(identical(other.delay, delay) || other.delay == delay)&&(identical(other.driverName, driverName) || other.driverName == driverName)&&(identical(other.durationString, durationString) || other.durationString == durationString)&&(identical(other.travelTime, travelTime) || other.travelTime == travelTime)&&const DeepCollectionEquality().equals(other._connections, _connections)&&const DeepCollectionEquality().equals(other._escalas, _escalas)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.state, state) || other.state == state)&&(identical(other.country, country) || other.country == country)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.estrelas, estrelas) || other.estrelas == estrelas)&&(identical(other.telefone, telefone) || other.telefone == telefone)&&(identical(other.website, website) || other.website == website)&&const DeepCollectionEquality().equals(other._images, _images)&&(identical(other.linkMaps, linkMaps) || other.linkMaps == linkMaps)&&(identical(other.eventoReferenciaId, eventoReferenciaId) || other.eventoReferenciaId == eventoReferenciaId)&&(identical(other.isDayAfterTransfer, isDayAfterTransfer) || other.isDayAfterTransfer == isDayAfterTransfer)&&const DeepCollectionEquality().equals(other._dados, _dados)&&(identical(other.price, price) || other.price == price)&&(identical(other.siteUrl, siteUrl) || other.siteUrl == siteUrl)&&(identical(other.bookingStatus, bookingStatus) || other.bookingStatus == bookingStatus)&&(identical(other.transferDate, transferDate) || other.transferDate == transferDate)&&(identical(other.transferHora, transferHora) || other.transferHora == transferHora)&&const DeepCollectionEquality().equals(other._attachments, _attachments)&&const DeepCollectionEquality().equals(other._passageiros, _passageiros)&&(identical(other.placeId, placeId) || other.placeId == placeId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,oldName,subtitle,typeString,dateString,timeString,endTimeString,startDateTimeOld,description,location,imageUrl,fromCode,toCode,fromCity,toCity,fromTime,toTime,isDelayed,delay,driverName,durationString,travelTime,const DeepCollectionEquality().hash(_connections),const DeepCollectionEquality().hash(_escalas),address,city,state,country,latitude,longitude,rating,estrelas,telefone,website,const DeepCollectionEquality().hash(_images),linkMaps,eventoReferenciaId,isDayAfterTransfer,const DeepCollectionEquality().hash(_dados),price,siteUrl,bookingStatus,transferDate,transferHora,const DeepCollectionEquality().hash(_attachments),const DeepCollectionEquality().hash(_passageiros),placeId]);
...
as List<Map<String, dynamic>>?,passageiros: freezed == passageiros ? _self._passageiros : passageiros // ignore: cast_nullable_to_non_nullable
as List<dynamic>?,placeId: freezed == placeId ? _self.placeId : placeId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
